...
def handle_inittarget(
    ...
    log.info("handle_inittarget2===:",outputcode=inputcode,is_valid=is_valid,msg=errormsg)
    if is_valid:
        ...
        log.info("handle_inittarget1===:",outputcode=inputcode)
        ...
        if safe_to_wait:
            ...
            log.info("handle_inittarget0===:target receive inputcode and return!",outputcode=inputcode)
